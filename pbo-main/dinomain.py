...
LARI = [pygame.image.load(os.path.join("pbo-main/Assets/Dino", "dinolari1.png")),
           pygame.image.load(os.path.join("pbo-main/Assets/Dino", "dinolari2.png"))]
LOMPAT = pygame.image.load(os.path.join("pbo-main/Assets/Dino", "dinolompat.png"))
NUNDUK = [pygame.image.load(os.path.join("pbo-main/Assets/Dino", "dinonunduk1.png")),
           pygame.image.load(os.path.join("pbo-main/Assets/Dino", "dinonunduk2.png"))]

BATU = [pygame.image.load(os.path.join("pbo-main/Assets/batu", "batukecil1.png")),
                pygame.image.load(os.path.join("pbo-main/Assets/batu", "batukecil2.png")),
                pygame.image.load(os.path.join("pbo-main/Assets/batu", "batubesar.png"))]
KAKTUS = [pygame.image.load(os.path.join("pbo-main/Assets/kaktus", "LargeCactus1.png")),
                pygame.image.load(os.path.join("pbo-main/Assets/kaktus", "LargeCactus2.png")),
                pygame.image.load(os.path.join("pbo-main/Assets/kaktus", "LargeCactus3.png"))]

BURUNG = [pygame.image.load(os.path.join("pbo-main/Assets/burung", "burunggg1-01.png")),
        pygame.image.load(os.path.join("pbo-main/Assets/burung", "burunggg2-01.png"))]

AWAN = pygame.image.load(os.path.join("pbo-main/Assets/Other", "awan.png"))

BG = pygame.image.load(os.path.join("pbo-main/Assets/Other", "jalan-01.png"))
BACKGROUND = pygame.image.load(os.path.join("pbo-main/Assets/Other", "cth_bg_gameDino.png"))
 

# musik
# MUSIK = pygame.mixer.music.load(os.path.join("Assets/musik", "musik.mp3"))
# pygame.mixer.music.play(-1)
MLOMPAT = pygame.mixer.Sound(os.path.join("pbo-main/Assets/musik", "smb_jump-super.wav"))
MNUNDUK = pygame.mixer.Sound(os.path.join("pbo-main/Assets/musik", "smb_kick.wav"))
GAMESELESAI = pygame.mixer.Sound(os.path.join("pbo-main/Assets/musik", "smb_gameover.wav"))

LAYAR.blit(BACKGROUND, (100, 100))
#class dinosaurus
...
def main():
    ...
    def background():
        ...
        image_lebar = BACKGROUND.get_rect()
